...
- **Fond d'écran personnalisé** : Trois modes
  ...
  - **Aléatoire depuis un dossier** : Choisit une image ou vidéo aléatoire dans un dossier à chaque lancement ; une option secondaire « Préférer les vidéos » préfère les vidéos lorsqu'elle est activée, avec un repli vers une image aléatoire si le dossier ne contient aucune vidéo ou si la vidéo échoue à s'initialiser
...
- Le fond d'écran vidéo peut échouer à s'initialiser au démarrage en raison de la contention du pipeline média MF (intermittent, non entièrement résolu) ; reconstruction automatique jusqu'à 2 fois, puis repli vers une image aléatoire — aucun écran noir
