...
public partial class TransparentBackdrop : SystemBackdrop
{
    ...
    )
    {
        ...
        connectedTarget.SystemBackdrop = com.CreateColorBrush(
        ...
        DwmApi.DwmEnableBlurBehindWindow(
            _hwnd,
            new DwmApi.DWM_BLURBEHIND()
            {
                dwFlags =
                    DwmApi.DWM_BLURBEHIND_Mask.DWM_BB_ENABLE
                    | DwmApi.DWM_BLURBEHIND_Mask.DWM_BB_BLURREGION,
                fEnable = true,
                hRgnBlur = rgn,
            }
        );
