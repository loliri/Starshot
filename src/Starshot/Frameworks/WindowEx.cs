...
public abstract partial class WindowEx : Window
{
    ...
    public WindowEx()
    {
        ...
        InputSiteHandle = (IntPtr)
            User32.FindWindowEx(bridge, IntPtr.Zero, "InputSiteWindowClass", null);
        ...
        System.Diagnostics.Debug.Assert(
            InputSiteHandle != IntPtr.Zero,
            "WindowEx: InputSiteHandle is zero — WM_HOTKEY will not be received"
        );
    }
    ...
    protected virtual unsafe IntPtr InputSiteSubclassProc(
        HWND hWnd,
        uint uMsg,
        IntPtr wParam,
        IntPtr lParam,
    ...
    public virtual void CenterInScreen(int? width = null, int? height = null)
    {
        ...
        DisplayArea display =
            DisplayArea.GetFromWindowId(MainWindowId, DisplayAreaFallback.Nearest)
            ?? DisplayArea.Primary;
